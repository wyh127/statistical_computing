...
Recall that the random variables we sampled are distributed as $N(3, 4)$, meaning in each column $X_1, X_2, \ldots, X_{100}$ independently and identically distributed (i.i.d.\) $\sim N(3,4)$.  Therefore $\bar{X}_{100} = \frac{1}{100} \sum_{i=1}^{100} X_i$, which we call the sample mean, $\sim N(3, 0.04)$.  This comes from the fact that if $X_1, X_2, \ldots, X_{n}$ are i.i.d.\ $\sim N(\mu, \sigma^2)$ then $\bar{X}_n \sim N(\mu, \sigma^2/n)$.
